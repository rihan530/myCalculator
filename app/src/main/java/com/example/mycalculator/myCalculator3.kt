...
//}
//
////Calculator 클래스를 calc 변수로 선언해서 계산 함수 호출
//fun calculate(num1: Int, operator : String, num2: Int): Double {
//    val calc = Calculator()
//    when (operator) {
//        "+" -> return calc.PlusOperation(num1, num2)
//        "-" -> return calc.MiusOperation(num1, num2)
//        "*" -> return calc.MultiplyOperation(num1, num2)
//        "/" -> return calc.DivisionOperation(num1, num2)
//    }
//    return 0.0
//}
//
